...
export const toolGroups: ToolGroup[] = [
  {
    ...
    tools: [
      ...
      { name: "HTML Formatter", slug: "html-formatter", description: "Format and tidy HTML markup.", href: "/tools/html-formatter", implemented: false },
      { name: "CSS Formatter", slug: "css-formatter", description: "Format and tidy CSS rules.", href: "/tools/css-formatter", implemented: false },
      ...
      { name: "Slug Generator", slug: "slug-generator", description: "Generate URL-safe slugs from text.", href: "/tools/slug-generator", implemented: false },
      { name: "Lorem Ipsum", slug: "lorem-ipsum", description: "Generate placeholder Lorem Ipsum text.", href: "/tools/lorem-ipsum", implemented: false },
    ],
  },
  {
    name: "Crypto & Hash",
    ...
    tools: [
      ...
      { name: "HMAC Generator", slug: "hmac-generator", description: "Generate HMAC signatures using SHA variants.", href: "/tools/hmac-generator", implemented: false },
    ],
  },
  {
    name: "Date & Time",
    ...
    tools: [
      ...
      { name: "Date Diff", slug: "date-diff", description: "Calculate the difference between two dates.", href: "/tools/date-diff", implemented: false },
    ],
  },
  {
    name: "Encode & Convert",
    ...
    tools: [
      { name: "Hex Encoder", slug: "hex-encoder", description: "Convert between text and hexadecimal.", href: "/tools/hex-encoder", implemented: false },
      { name: "Binary Converter", slug: "binary-converter", description: "Convert between text and binary.", href: "/tools/binary-converter", implemented: false },
      { name: "CSV to JSON", slug: "csv-to-json", description: "Convert CSV data into structured JSON.", href: "/tools/csv-to-json", implemented: false },
      { name: "JSON to CSV", slug: "json-to-csv", description: "Convert JSON into CSV rows.", href: "/tools/json-to-csv", implemented: false },
    ],
  },
  {
    name: "Web & Network",
    ...
    tools: [
      { name: "HTTP Headers", slug: "http-headers", description: "Inspect response headers for any URL.", href: "/tools/http-headers", implemented: false },
      { name: "Redirect Checker", slug: "redirect-checker", description: "Trace the full redirect chain for a URL.", href: "/tools/redirect-checker", implemented: false },
      { name: "SSL Checker", slug: "ssl-checker", description: "Inspect a TLS certificate and its chain.", href: "/tools/ssl-checker", implemented: false },
      { name: "DNS Lookup", slug: "dns-lookup", description: "Query DNS records for a domain.", href: "/tools/dns-lookup", implemented: false },
      { name: "WHOIS Lookup", slug: "whois-lookup", description: "Look up WHOIS records for a domain.", href: "/tools/whois-lookup", implemented: false },
