...
const editorClass =
  "min-h-[440px] w-full rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2 font-mono text-sm text-zinc-900 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100";
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)]">
          <section>
            ...
            <div className="rounded-b-2xl rounded-tr-2xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <div className="space-y-4">
                ...
                {compileOutput && (
                  <div className="rounded-xl border border-amber-200 bg-amber-50 p-3 dark:border-amber-800 dark:bg-amber-950/20">
                    ...
                    <pre className="max-h-40 overflow-auto whitespace-pre-wrap font-mono text-sm text-amber-900 dark:text-amber-200">
                      {compileOutput}
                    </pre>
                  </div>
                )}
                ...
                {outputTab === "output" ? (
                  <div>
                    ...
                    <pre className="max-h-96 overflow-auto whitespace-pre-wrap rounded-xl border border-zinc-200 bg-white p-4 font-mono text-sm text-zinc-800 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-200">
                  ...
                  <div>
                    ...
                    <pre className="max-h-96 overflow-auto whitespace-pre-wrap rounded-xl border border-red-200 bg-red-50 p-4 font-mono text-sm text-red-700 dark:border-red-800 dark:bg-red-950/20 dark:text-red-300">
