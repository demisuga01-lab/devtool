...
import { Button, Checkbox, CodeBlock, CopyButton, ErrorCard, Label, Textarea } from "@/components/ui";
...
export default function XmlToJsonPage() {
  ...
  return <ToolShell slug="xml-to-json"><div className="space-y-5">
    <div><Label>XML</Label><Textarea value={input} onChange={(e) => setInput(e.target.value)} rows={10} /></div>
