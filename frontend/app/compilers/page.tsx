...
const icons = {
  ...
  zig: <svg viewBox="0 0 48 48" className="h-10 w-10"><rect width="48" height="48" rx="4" fill="#F7A41D"/><path d="M10 14h20l-8 10 8 10H10l8-10-8-10zm18 0h10v6l-4 4 4 4v6H28l-6-10 6-10z" fill="black"/></svg>,
  nim: <svg viewBox="0 0 48 48" className="h-10 w-10"><rect width="48" height="48" rx="4" fill="#FFE953"/><path d="M24 10l14 8-14 8-14-8 14-8zm0 10l14 8-14 8-14-8 14-8z" fill="#1C1C1C" opacity="0.8"/></svg>,
  crystal: <svg viewBox="0 0 48 48" className="h-10 w-10"><rect width="48" height="48" rx="4" fill="#000"/><path d="M24 6l14 8v16l-14 8L10 30V14L24 6zm0 4L13 16v16l11 6 11-6V16L24 10z" fill="white"/></svg>,
  ...
  racket: <svg viewBox="0 0 48 48" className="h-10 w-10"><circle cx="24" cy="24" r="20" fill="#9F1D20"/><path d="M24 4C13 4 4 13 4 24c0 5.5 2.2 10.5 5.8 14.1C14 27 19 18 24 14c5 4 10 13 14.2 24.1C42 34.5 44 29.5 44 24c0-11-9-20-20-20z" fill="white"/></svg>,
  ...
  coffeescript: <svg viewBox="0 0 48 48" className="h-10 w-10"><rect width="48" height="48" rx="4" fill="#2F2625"/><path d="M24 12c-7 0-12 5-12 12s5 12 12 12 12-5 12-12-5-12-12-12zm0 20c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8z" fill="#C0A882"/></svg>,
...
const languages: Language[] = [
  { id: "python", name: "Python", href: "/tools/scripting-runner", categories: ["popular", "scripting"], icon: icons.python },
  { id: "javascript", name: "JavaScript", href: "/tools/web-runner", categories: ["popular", "web"], icon: icons.javascript },
  { id: "java", name: "Java", href: "/tools/jvm-runner", categories: ["popular", "jvm"], icon: icons.java },
  { id: "c", name: "C", href: "/tools/systems-runner", categories: ["popular", "systems"], icon: icons.c },
  { id: "cpp", name: "C++", href: "/tools/systems-runner", categories: ["popular", "systems"], icon: icons.cpp },
  { id: "csharp", name: "C#", href: "/tools/jvm-runner", categories: ["popular", "jvm"], icon: icons.csharp },
  { id: "typescript", name: "TypeScript", href: "/tools/web-runner", categories: ["popular", "web"], icon: icons.typescript },
  { id: "go", name: "Go", href: "/tools/systems-runner", categories: ["popular", "systems"], icon: icons.go },
  { id: "rust", name: "Rust", href: "/tools/systems-runner", categories: ["popular", "systems"], icon: icons.rust },
  { id: "kotlin", name: "Kotlin", href: "/tools/jvm-runner", categories: ["popular", "jvm"], icon: icons.kotlin },
  { id: "php", name: "PHP", href: "/tools/scripting-runner", categories: ["popular", "scripting", "web"], icon: icons.php },
  { id: "ruby", name: "Ruby", href: "/tools/scripting-runner", categories: ["popular", "scripting"], icon: icons.ruby },
  { id: "swift", name: "Swift", href: "/tools/other-runner", categories: ["popular", "systems"], icon: icons.swift },
  { id: "dart", name: "Dart", href: "/tools/other-runner", categories: ["popular", "web"], icon: icons.dart },
  { id: "basic", name: "Basic", href: "/tools/jvm-runner", categories: ["jvm"], icon: icons.basic },
  { id: "visualbasic", name: "Visual Basic", href: "/tools/jvm-runner", categories: ["jvm"], icon: icons.basic },
  { id: "html", name: "HTML", href: "/tools/web-runner", categories: ["web"], icon: icons.html },
  { id: "css", name: "CSS", href: "/tools/web-runner", categories: ["web"], icon: icons.css },
  { id: "coffeescript", name: "CoffeeScript", href: "/tools/web-runner", categories: ["web", "scripting"], icon: icons.coffeescript },
  { id: "d", name: "D", href: "/tools/other-runner", categories: ["systems"], icon: icons.d },
  { id: "zig", name: "Zig", href: "/tools/systems-runner", categories: ["systems"], icon: icons.zig },
  { id: "fortran", name: "Fortran", href: "/tools/other-runner", categories: ["systems", "data"], icon: icons.fortran },
  { id: "nasm", name: "Assembly", href: "/tools/other-runner", categories: ["lowlevel"], icon: icons.assembly },
  { id: "scala", name: "Scala", href: "/tools/jvm-runner", categories: ["jvm", "functional"], icon: icons.scala },
  { id: "groovy", name: "Groovy", href: "/tools/jvm-runner", categories: ["jvm"], icon: icons.groovy },
  { id: "clojure", name: "Clojure", href: "/tools/jvm-runner", categories: ["jvm", "functional"], icon: icons.clojure },
  { id: "perl", name: "Perl", href: "/tools/scripting-runner", categories: ["scripting"], icon: icons.perl },
  { id: "lua", name: "Lua", href: "/tools/scripting-runner", categories: ["scripting"], icon: icons.lua },
  { id: "bash", name: "Bash", href: "/tools/scripting-runner", categories: ["scripting"], icon: icons.bash },
  { id: "haskell", name: "Haskell", href: "/tools/other-runner", categories: ["functional"], icon: icons.haskell },
  { id: "elixir", name: "Elixir", href: "/tools/other-runner", categories: ["functional"], icon: icons.elixir },
  { id: "erlang", name: "Erlang", href: "/tools/other-runner", categories: ["functional"], icon: icons.erlang },
  { id: "ocaml", name: "OCaml", href: "/tools/other-runner", categories: ["functional"], icon: icons.ocaml },
  { id: "racket", name: "Racket", href: "/tools/other-runner", categories: ["functional"], icon: icons.racket },
  { id: "prolog", name: "Prolog", href: "/tools/other-runner", categories: ["functional"], icon: icons.prolog },
  { id: "r", name: "R", href: "/tools/data-runner", categories: ["data"], icon: icons.r },
  { id: "julia", name: "Julia", href: "/tools/data-runner", categories: ["data", "systems"], icon: icons.julia },
  { id: "sqlite", name: "SQLite", href: "/tools/data-runner", categories: ["data", "database"], icon: icons.sqlite },
  { id: "cobol", name: "COBOL", href: "/tools/other-runner", categories: ["data"], icon: icons.cobol },
  { id: "mysql", name: "MySQL", href: "/tools/database-runner", categories: ["database"], icon: icons.mysql },
  { id: "postgresql", name: "PostgreSQL", href: "/tools/database-runner", categories: ["database"], icon: icons.postgresql },
  { id: "mongodb", name: "MongoDB", href: "/tools/database-runner", categories: ["database"], icon: icons.mongodb },
  { id: "nasm64", name: "NASM x64", href: "/tools/other-runner", categories: ["lowlevel"], icon: icons.assembly },
  { id: "crystal", name: "Crystal", href: "/tools/other-runner", categories: ["systems"], icon: icons.crystal },
  { id: "nim", name: "Nim", href: "/tools/other-runner", categories: ["systems"], icon: icons.nim },
  { id: "pascal", name: "Pascal", href: "/tools/other-runner", categories: ["systems"], icon: icons.pascal },
  { id: "rscript", name: "R Script", href: "/tools/data-runner", categories: ["data"], icon: icons.rscript },
];
