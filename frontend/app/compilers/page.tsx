...
const icons = {
  ...
  commonlisp: <svg viewBox="0 0 48 48" className="h-10 w-10"><rect width="48" height="48" rx="4" fill="#3F6B43"/><path d="M15 12h6v18h10v6H15V12zm17 0h4v24h-4V12z" fill="white"/></svg>,
...
const languages: Language[] = [
  ...
  { id: "visualbasic", name: "Visual Basic", href: "/tools/other-runner", categories: ["jvm"], icon: icons.basic },
  { id: "fsharp", name: "F#", href: "/tools/other-runner", categories: ["functional", "jvm"], icon: icons.fsharp },
  ...
  { id: "objc", name: "Objective-C", href: "/tools/other-runner", categories: ["systems"], icon: icons.objc },
  ...
  { id: "groovy", name: "Groovy", href: "/tools/other-runner", categories: ["jvm"], icon: icons.groovy },
  ...
  { id: "octave", name: "Octave", href: "/tools/other-runner", categories: ["data"], icon: icons.octave },
  ...
  { id: "commonlisp", name: "Common Lisp", href: "/tools/other-runner", categories: ["functional"], icon: icons.commonlisp },
